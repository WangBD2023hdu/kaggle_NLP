...
val_pd = pd.DataFrame(val_data)
test_pd = pd.DataFrame(test_data)
train_pd.to_excel("for_model_train.xlsx", index=False)
val_pd.to_excel("for_model_val.xlsx", index=False)
test_pd.to_excel("for_model_test.xlsx", index=False)
